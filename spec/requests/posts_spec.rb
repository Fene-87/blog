...
RSpec.describe "Posts", type: :request do
    describe 'GET' do
        ...
        describe '/posts/show' do
            before(:each) do
                user = User.create!(name: 'Mark', photo: 'https://i.imgur.com/1.jpg', bio: 'Hey I am Mark.', postscounter: 1)
                post = Post.create!(author: user, title: 'First Post', text: 'This is a the first post.', comments_counter: 0, likes_counter: 0)
            ...
            it('includes placeholder text') do
                expect(response.body).to include('<h1>Here is post information for a given post</h1>')
            end
        end
    end
end